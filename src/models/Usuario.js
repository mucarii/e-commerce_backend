...
class Usuario {
  ...
  /**
   * Insere um novo usuário (somente com o nome).
   * @param {Usuario} usuarioInstancia
  ...
  /**
   * Lista todos os usuários (apenas _id, nome e data_registro).
   * @param {{}} filtro
